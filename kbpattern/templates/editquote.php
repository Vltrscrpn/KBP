...
<body onload="document.form.customer.focus()">
    ...
    <table>
    	...
    	<tr>
    	 ...
    	 <td><input type="text" name="patternNumber" value="<?php echo $edit['quote']['patternNumber']?>"  tabindex=4/></td>
    	</tr>
    	<tr>
    	 <td>Est. Delivery</td>
    	 <td><input type="text" name="estDelivery" value="<?php echo $edit['quote']['estimatedDelivery']?>"  tabindex=3/></td>
    	 <td>Pattern Owner</td>
    	 <td><input type="text" name="patternOwner" value="<?php echo $edit['quote']['patternOwner']?>"  tabindex=5/></td>
    	</tr>
    </table>
    
    <div class="spacer"></div>
    <br/> Instruction <small>(click to add)</small><br/> 
    <input type="hidden" id="count" value="<?php echo count($edit['instruct']); ?>"/>
...
<div class="ui-widget">
    ...
    <table>
    	...
    	<tr>
    	 <td><input type="text" id="totalhrs" name="totalHours" value="<?php echo $copy['quote']['totalHours']?>" /><input type="hidden" id="shoprate" name="shopRate" value="59.00" /></td>
    	 <td><input type="text" id="totalmat" name="totalMaterial" value="<?php echo $copy['quote']['totalMaterial']?>" /><input type="hidden" id="margin" name="margin" value="30" /></td>
